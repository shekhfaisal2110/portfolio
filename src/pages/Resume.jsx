...
// //     desc: (
// //       <>
// //         Pursuing BCA from <span className="text-white font-semibold" title="University Name">Sardar Vallabhbhai Global University</span>, specializing in web and software development. Currently holding a{' '}
// //         <span className="text-white font-semibold" title="Current CGPA">CGPA of 8.36</span>.
// //       </>
// //     ),
// //   },
// //   {
...
// //     desc: (
// //       <>
// //         Studied at <span className="text-white font-semibold" title="Higher Secondary School">Devdi-Gerajpur High School</span>, under the Gujarat Board. Achieved{' '}
// //         <span className="text-white font-semibold" title="Final Result">88%</span>. Focused on Accountancy, Economics, and Business Studies, building analytical and financial skills.
// //       </>
// //     ),
// //   },
// //   {
...
// //     desc: (
// //       <>
// //         Completed secondary education from <span className="text-white font-semibold" title="High School">Devdi-Gerajpur High School</span>, affiliated with the Gujarat Board. Secured{' '}
// //         <span className="text-white font-semibold" title="Final Result">85%</span>, building a strong academic foundation in core subjects.
// //       </>
// //     ),
// //   },
// // ];
...
// //         <br />
// //         • <strong className="text-white">🎧 Audio Quran</strong> – a responsive Surah-wise Quran audio player.{' '}
// //         <a
...
// //         </a>
// //         <br />
// //         • <strong className="text-white">📿 Tasbeeh Counter</strong> – a digital prayer counter with persistent local storage.{' '}
// //         <a
...
// //         <strong className="text-white">🌍 UniversalTravels</strong> – a fully responsive travel website built with HTML, CSS, and JavaScript.
...
// //   },
// // ];
// // const TimelineItem = ({ title, date, desc, link }) => {
// //   return (
// //     <div className="relative pl-10 mb-8 group">
// //       <div className="absolute left-0 top-2 w-4 h-4 rounded-full border-2 border-white bg-gradient-to-br from-cyan-400 to-blue-600 shadow-md group-hover:scale-125 group-hover:shadow-blue-500 transition-transform duration-300"></div>
// //       <div className="bg-[#1f1f1f] p-4 rounded-lg shadow-md group-hover:-translate-y-1 group-hover:shadow-blue-600 transition-all duration-300">
...
// //             target="_blank"
// //             rel="noopener noreferrer"
// //             className="inline-block mt-2 text-sm text-blue-400 hover:underline hover:text-blue-300 transition duration-200"
// //           >
// //             🔗 View Project
// //           </a>
// //         )}
...
// //         <h2
// //           id="resume-title"
// //           className="text-3xl font-bold text-center mb-12 flex justify-center items-center gap-2"
// //         >
// //           <img src={cvImg} alt="Resume Icon" className="w-8 h-8" />
// //           My Resume
// //         </h2>

// //         {/* Resume Buttons */}
// //         <div className="text-center mb-10 flex justify-center gap-4 flex-wrap">
// //           {/* Download Button */}
// //           <a
// //             href={ResumePdf}
// //             download="Shekh-Faisal-Resume"
// //             className="inline-block bg-gradient-to-r from-indigo-500 to-blue-600 text-white py-2 px-6 rounded-full font-medium hover:from-indigo-600 hover:to-blue-700 transition-all duration-300"
...
// //             target="_blank"
// //             rel="noopener noreferrer"
// //             className="inline-block border border-indigo-500 text-indigo-400 py-2 px-6 rounded-full font-medium hover:bg-indigo-600 hover:text-white transition-all duration-300"
...
// //           {/* Education */}
// //           <div>
// //             <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-600 bg-clip-text text-transparent transition-transform duration-300 hover:scale-105">
// //               🎓 Education
// //             </h3>
...
// import React, { useState, useEffect } from 'react';
// import { FaGraduationCap, FaBriefcase, FaDownload, FaEye, FaCode, FaRocket, FaCalendarAlt, FaExternalLinkAlt } from 'react-icons/fa';
// import cvImg from '../assets/icons/cv.png';
// import ResumePdf from '../pages/Shekh_Faisal(resume).pdf'
...
//             target="_blank"
//             rel="noopener noreferrer"
//             className="text-cyan-400 hover:text-cyan-300 hover:underline inline-block mt-2 transition-colors duration-300"
//           >
//             🔗 View Project
//           </a>
//         </>
...
//   const TimelineItem = ({ title, date, desc, icon, gradient }) => {
//     return (
//       <div className="relative pl-16 mb-8 group">
//         {/* Enhanced Timeline Dot */}
//         <div className="absolute left-0 top-2 group">
...
//           <div className={`relative w-12 h-12 rounded-full bg-gradient-to-r ${gradient} shadow-lg flex items-center justify-center transform group-hover:scale-110 transition-all duration-300`}>
//             <span className="text-white text-lg">{icon}</span>
//           </div>
//         </div>
        
//         {/* Timeline Line */}
//         <div className="absolute left-6 top-14 w-0.5 h-full bg-gradient-to-b from-cyan-400/50 to-transparent"></div>
        
//         {/* Enhanced Card */}
//         <div className="group relative">
//           <div className="absolute -inset-1 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 rounded-2xl blur opacity-0 group-hover:opacity-50 transition duration-500" />
//           <div className="relative bg-white/10 backdrop-blur-lg p-6 rounded-2xl border border-white/20 hover:border-white/30 transition-all duration-500 hover:bg-white/20 hover:shadow-lg hover:scale-105 hover:-translate-y-2">
            
//             <div className="relative z-10">
//               <h4 className="text-xl font-bold text-white mb-3 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
//                 {title}
//               </h4>
              
//               <div className="flex items-center gap-2 mb-4">
//                 <FaCalendarAlt className="text-cyan-400 text-sm" />
//                 <span className="text-sm text-cyan-400 font-medium px-3 py-1 rounded-full bg-cyan-400/20 border border-cyan-400/30">
//                   {date}
//                 </span>
//               </div>
...
//                 href={ResumePdf}
//                 download="Shekh-Faisal-Resume"
//                 className="relative flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-lg rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:-translate-y-1"
//                 aria-label="Download Resume"
//               >
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="relative flex items-center gap-3 px-10 py-5 bg-white/10 backdrop-blur-lg border-2 border-white/30 text-white font-bold text-lg rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:bg-white/20"
//                 aria-label="View Resume"
//               >
...
//                   <div className="relative z-10">
//                     <h3 className="text-3xl font-bold mb-8 bg-gradient-to-r from-cyan-400 to-blue-600 bg-clip-text text-transparent animate-gradient flex items-center gap-4">
...
//                   <div className="relative z-10">
//                     <h3 className="text-3xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent animate-gradient flex items-center gap-4">
...
//           <div className={`mt-16 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
//             <div className="text-center">
//               <h3 className="text-3xl font-bold mb-8 bg-gradient-to-r from-green-400 to-cyan-500 bg-clip-text text-transparent">
//                 Core Skills
//               </h3>
//               <div className="flex flex-wrap justify-center gap-4">
//                 {[
...
//             <div className="flex flex-wrap justify-center gap-6">
//               <div className="group relative">
//                 <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-emerald-500 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-300" />
//                 <a
//                   href="#contact"
//                   className="relative flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 rounded-xl text-white font-semibold transition-all duration-300 transform hover:scale-105"
//                 >
...
//               <div className="group relative">
//                 <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-red-500 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-300" />
//                 <a
//                   href="#portfolio"
//                   className="relative flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 rounded-xl text-white font-semibold transition-all duration-300 transform hover:scale-105"
//                 >
