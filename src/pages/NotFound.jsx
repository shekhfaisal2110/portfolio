...
// // import errorGif from "../../src/assets/productNotFound/error.gif"; 
...
// //   return (
// //     <div className="w-screen h-screen bg-white text-gray-800 flex flex-col items-center justify-center text-center relative overflow-hidden px-4">

// //       {/* Content */}
// //       <div className="relative z-10 max-w-xl w-full flex flex-col items-center">
// //         <h1 className="text-6xl sm:text-7xl font-black text-red-500 animate-pulse mb-2">
// //           404
// //         </h1>
...
// //           speed={50}
// //           repeat={Infinity}
// //           className="text-2xl sm:text-3xl font-semibold mb-4 text-cyan-400"
// //         />
...
// //         <Link
// //           to="/"
// //           className="inline-flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold py-2 px-6 rounded-full shadow-md transition-all duration-300"
// //         >
// //           <FaArrowLeft />
// //           Go to Homepage Now
// //         </Link>
